...
/*
타입스크립트를 사용하는 프로젝트에서 리덕스를 사용할 때 이 모듈에서 액션 타입을 선언하게 될 때,
as const를 이용해서 유틸함수인 ReturnType 사용하여 액션에 대한 모든 타입스크립트 타입을 유추할 수 있음
...
// type CounterAction =
//   | ReturnType<typeof increase>// 이미 선언한 것에 대해서 가져오는 것
//   | ReturnType<typeof decrease>// 유틸타입의 ReturnType 이걸 통해서 특정 함수에 결과물을 받아올 수 있음
